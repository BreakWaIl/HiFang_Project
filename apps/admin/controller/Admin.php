...
{ 
    public function _initialize() {
        ...
        if (!AdminLogic::checkAllowLoginByTime()) {
            ...
            $url = $domain.'/admin.php/admin/login/logout';
            $this->error('您的帐号正在别的地方登录!',"javascript:top.location.href='".$url."'");
        }
    ...
    public function setStatus($model = CONTROLLER_NAME, $script = false) {
        ...
        switch ($status) {
            ...
            case 'delete'  :  // 删除条目
                ...
                break;
            /**删除视频和封面图(七牛云上的视频和封面图)
             * @param
             * @time 2018/4/27 10:21
             * @auther zyt
             */
            case 'deleteVideo'  :  // 删除条目
                //action_log(0, is_login(), ['param'=>$this->request->param()],'删除操作');
                $video = model($model)->where($map)->find();
