...
function CheckAuthentication()
{
    ...
    return true;
	return !empty($_SESSION['customer_name'])?true:false;
}
...
* 黄金会员 100M
* 钻石会员 150M
*  size unit type  // b => bit  k=>kb  m=>mb g=>gb t=>tb
*  以 ‘M’ 为单位*/
/*$config['Resource_Space_Size'] = array(
    'unit_type' => 'mb',
    'vip_type' => 'vip3',
    'member_level' => array(
        'vip1' => 50,
...
*/
//D:/xampp/htdocs/tp5/public/Attachments/
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,txt,apk,pdf',
		'deniedExtensions' => '');
...
$config['plugin_imageresize']['smallThumb'] = '90x90'; //90x90
$config['plugin_imageresize']['mediumThumb'] = '120x120'; //120x120
$config['plugin_imageresize']['largeThumb'] = '180x180'; //180x180
